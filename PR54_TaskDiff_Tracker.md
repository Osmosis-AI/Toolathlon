...
- **3** keep ours (own/refined version differs from PR): `student-interview`, `woocommerce-product-recall`, `detect-revised-terms`.
- **2** set aside (keep our version for now): `nvidia-stock-analysis`, `search-ca-school`.
